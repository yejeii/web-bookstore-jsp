...
<head>
  ...
  <!-- Site Title -->
	...
	<!-- CSS -->
	<link href="${request.getContextPath() }/vendor/owl-carousel/css/owl.carousel.min.css" rel="stylesheet">
  <link href="${request.getContextPath() }/vendor/owl-carousel/css/owl.theme.default.min.css" rel="stylesheet">
  <link href="${request.getContextPath() }/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
...
<body>
  ...
  <script src="/js/manager/dashboard/dashboard-1.js"></script>
