...
<body>
    		...
    		<!-- Register row -->
              ...
              <div class="card-body">
              	<div class="basic-form">
              		<form action="/manager/bookManage/bookModifyPro.ma" method="post" name="bookForm" enctype="multipart/form-data">
              			<div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                      	...
                      	<div id="uploadResult" class="my-2">
                      		<!-- 도서 이미지가 들어가는 곳 -->
                      		<img id="bookImage" src="${request.getSession().getServletContext().getRealPath('/') }/bookImage/${book.b_image }" 
                      ...
                      <div class="form-row col-md-8 form_row_8_div">
                      	<div class="col-12">
		                    ...
		                    <div class="col-4">
		                        ...
		                        <div class="input-group input-group-merge">
			                        <input type="text" class="form-control" name="b_page" id="b_page" required="required" value="${book.b_page }">  
	                  ...
	                  <div class="form-row">
		                  <div class="form-group col-xxl-12">
		                  	...
		                  	<textarea class="form-control" rows="10" wrap="off" 
		                  						id="b_content" name="b_content" required="required">${book.b_content }</textarea>
		                  </div>
                  	...
                  	<button type="button" class="btn btn-outline-primary btn-lg regist_btn">수정</button>
                  	<button type="button" class="btn btn-outline-danger btn-lg" 
                  					onclick="window.location.href='/manager/bookManage/bookDeletePro.ma?b_id=${book.b_id}'">삭제</button>
              		</form>
              	</div>
              </div>
						</div>				
  ...
  <script src="/js/manager/plugins-init/summernote-init.js"></script>
  <!-- YJ -->
  ...
  <script language=JavaScript src="/js/yj/book.form-select-catgy.js"></script>
  <script language=JavaScript src="/js/yj/book.check-valid.js"></script>
  <!-- Script -->
