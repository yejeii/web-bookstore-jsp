    		...
    		<!-- Register row -->
              ...
              <div class="card-body">
              	<div class="basic-form">
              		<form action="/manager/bookManage/bookRegistPro.ma" method="post" name="bookForm" enctype="multipart/form-data">
              			<div class="form-row">
                      ...
                      <div class="form-row col-md-8 form_row_8_div">
	                      ...
	                      <div class="col border rounded border-secondary mx-2 p-3 d-none add_div" 
		                      ...
		                      <!-- 서브 카테고리 추가 -->
		                      <!-- <div class="row col-12 wrapper wrapper_div1">
										        <div class="col-md-6 col-xl-3 mb-2">
										        	<label for="b_main_catgy">카테고리 대분류</label>
										            <select class="form-control" name="b_main_catgy">
										            	<option value="">전체</option>
										            </select>
										        </div>
										        <div class="col-md-6 col-xl-3 mb-2">
										            <label for="b_middle_catgy">카테고리 중분류</label>
										            <select class="form-control" name="b_middle_catgy">
										            	<option value="">--</option>
										            </select>
										        </div>
										        <div class="col-md-6 col-xl-3 mb-2">
										            <label for="b_sub_catgy">카테고리 소분류</label>
										            <select class="form-control" name="b_sub_catgy">
										            	<option value="">--</option>
										            </select>
										        </div>
										        <div class="col-md-6 col-xl-3 mb-2 mt-4">
										        	<button type="button" class="btn btn-warning add_catgy_btn">삭제
